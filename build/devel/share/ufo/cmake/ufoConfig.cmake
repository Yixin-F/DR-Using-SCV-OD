...
if(ufo_CONFIG_INCLUDED)
  return()
endif()
set(ufo_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(ufo_SOURCE_PREFIX /home/fyx/ufo_hiahia/src/ufo)
  set(ufo_DEVEL_PREFIX /home/fyx/ufo_hiahia/src/ufo/build/devel)
  set(ufo_INSTALL_PREFIX "")
  set(ufo_PREFIX ${ufo_DEVEL_PREFIX})
else()
  set(ufo_SOURCE_PREFIX "")
  set(ufo_DEVEL_PREFIX "")
  set(ufo_INSTALL_PREFIX /usr/local)
  set(ufo_PREFIX ${ufo_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'ufo' is deprecated")
...
set(ufo_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/fyx/ufo_hiahia/src/ufo/include;/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  set(ufo_INCLUDE_DIRS "")
  set(_include_dirs "/home/fyx/ufo_hiahia/src/ufo/include;/usr/include/pcl-1.8;/usr/local/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'SEU fyx <917449595@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${ufo_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ufo' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'ufo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/fyx/ufo_hiahia/src/ufo/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ufo_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND ufo_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND ufo_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT ufo_NUM_DUMMY_TARGETS)
      set(ufo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::ufo::wrapped-linker-option${ufo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR ufo_NUM_DUMMY_TARGETS "${ufo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::ufo::wrapped-linker-option${ufo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND ufo_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/fyx/ufo_hiahia/src/ufo/build/devel/lib;/home/fyx/erasor/devel/lib;/home/fyx/ufo_hiahia/devel/lib;/home/fyx/ufo_final/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(ufo_LIBRARY_DIRS ${lib_path})
      list(APPEND ufo_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'ufo'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND ufo_LIBRARIES ${lib})
    endif()
  endif()
...
set(ufo_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${ufo_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 ufo_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${ufo_dep}_FOUND)
      find_package(${ufo_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ufo_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(ufo_INCLUDE_DIRS ${${ufo_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(ufo_LIBRARIES ${ufo_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${ufo_dep}_LIBRARIES})
  _list_append_deduplicate(ufo_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(ufo_LIBRARIES ${ufo_LIBRARIES})

  _list_append_unique(ufo_LIBRARY_DIRS ${${ufo_dep}_LIBRARY_DIRS})
  list(APPEND ufo_EXPORTED_TARGETS ${${ufo_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${ufo_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
